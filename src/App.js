...
const INITIAL_MOVIE_buttonST = [
  ...
  },
  {
    ...
    rating: "6.8",
    url:"https://youtu.be/cpNaGiBhXiM",
  ...
  },
  {
    ...
    title: "Tumbbad",
    rating: "8.2",
    url:"https://youtu.be/sN75MPxgvX8",
  ...
  },
  {
    ...
    rating: "5.2",
    url:"https://youtu.be/kP9TfCWaQT4",
...
function Movieapp() {
  const movies = INITIAL_MOVIE_buttonST;
  return (
    <div className='main-container'>
      {movies.map((data ,index) => (<Movies movie={data} id={index} />))}
    </div>
  );
}
